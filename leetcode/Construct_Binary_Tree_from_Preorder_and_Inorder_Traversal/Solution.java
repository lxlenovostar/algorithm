...
public class Solution{
   ...
   /** 
	...
	private TreeNode help_BuildTree(int[] preorder, int prestart, int preend, int[] inorder, int instart, int inend) {
		...
		//root.left = help_BuildTree(inorder, instart, position - 1, preorder, prestart, prestart + (position - instart - 1)); 
		//root.right = help_BuildTree(inorder, position+1, inend, preorder, prestart + (position - instart - 1) + 1, preend - 1); 
